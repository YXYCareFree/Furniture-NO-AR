...
- (void)setCurrentImageIndex:(NSInteger)currentImageIndex{
    ...
    if ([self.delegate respondsToSelector:@selector(photoBrowser:placeholderImageForIndex:)]) {
        ...
        UIImageView * imageView = [self.delegate photoBrowser:self placeholderImageForIndex:currentImageIndex];
        ...
        NSLog(@"%@", NSStringFromCGRect(_tempRect));
...
#pragma mark--show dismiss clear
- (void)show{
